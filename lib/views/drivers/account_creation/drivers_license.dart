...
class DriversLicense extends StatefulWidget {
  const DriversLicense({super.key});

  @override
  State<DriversLicense> createState() => _DriversLicenseState();
}

class _DriversLicenseState extends State<DriversLicense> {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                StringManager.driverLicenseText,
                style: TextStyle(
                    color: mainTextColor,
                    fontSize: 16,
